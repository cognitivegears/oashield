...
public class OperationProcessor {
     ...
     * @param patternGenerationService The pattern generation service
     */
    public OperationProcessor(ConfigurationManager configManager, PatternGenerationService patternGenerationService) {
