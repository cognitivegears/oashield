...
public class ConfigurationManager {
    ...
    public void initialize() {
        ...
        log.debug("ConfigurationManager initialized with output folder: {}", outputFolder);
    }
    ...
    public void processOpts() {
        ...
        if (additionalProperties.containsKey("generateJsonSchema")) {
            ...
            log.info("generateJsonSchema set to: {}", generateJsonSchema);
        }
        ...
        if (additionalProperties.containsKey("validateBodySchema")) {
            ...
            log.info("validateBodySchema set to: {}", validateBodySchema);
        }
        ...
        if (additionalProperties.containsKey("jsonSchemaOutputFile")) {
            ...
            log.info("jsonSchemaOutputFile set to: {}", jsonSchemaOutputFile);
        }
    }
}
